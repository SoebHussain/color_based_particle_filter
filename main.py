...
im = cv2.imread('/Users/soebhussain/Desktop/Summer2018/VOT2014/ball_img/00000001.jpg')
...
folder = "/Users/soebhussain/Desktop/Summer2018/VOT2014/ball_img"
tum = 0
#cv2.waitKey(0)
for filename in os.listdir(folder):
    ...
    W = observe(img,S,target,sigma,bin,channel,W)
    #print(W)
    #print(W)
    W = W/sum(W)
    print(W)
    ...
    #h = int(2* sup[4])
    #print(x,y,w,h)
    #cv2.rectangle(img,(x,y),(x+w,y+h),(255,232,),2)
    #cv2.imshow('finally something to see',img)
